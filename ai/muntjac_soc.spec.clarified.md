...
System components are as follows:
  ...
  * Define toolchain build file in `//boards/muntjac/tool.vivado`.
  ...
  * Attach Muntjac to a tilelink-to-wishbone converter (`tl_c2wblite` or `tl2wb`), 
    and use a Wishbone demultiplexer to route traffic to the DDR3 multiplexer 
    and the UART16550.
  * Attach the UART16650 from `//third_party/uart16550` to the Wishbone bus 
    exposed by Muntjac's converter. Use `//ip/general/uartmux.vhdl`
